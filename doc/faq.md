...
>I should point out that itâs Google â not me â recommending to place this
...
wouldnât count that as a page view, so I actually prefer to place this script
...
concatenate and minify all my scripts into one .js file â the GA snippet being
the suffix.)
